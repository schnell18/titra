...
Meteor.methods({
  updateSettings({
    ...
    check(APItoken, Match.Maybe(String))
    check(holidayCountry, Match.Maybe(String))
    check(holidayState, Match.Maybe(String))
    check(holidayRegion, Match.Maybe(String))
    check(zammadtoken, Match.Maybe(String))
    check(zammadurl, Match.Maybe(String))
    check(gitlabtoken, Match.Maybe(String))
    check(gitlaburl, Match.Maybe(String))
